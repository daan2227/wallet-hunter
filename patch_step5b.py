...
"""
patch_step5b.py
Reescribe recovery_engine.cpp usando las funciones reales del proyecto:
  pk_to_h160()   → privkey → HASH160
  h160_to_addr() → HASH160 → dirección Base58
Ejecutar desde la raiz del proyecto: python3 patch_step5b.py
"""
...
with open(engine_path, "w") as f:
    f.write(engine_cpp)
print(f"✓ recovery_engine.cpp reescrito")

print("""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Paso 5b completado.

recovery_engine.cpp ahora usa:
  pk_to_h160_local()   (copia interna de pk_to_h160)
  h160_to_addr_local() (copia interna de h160_to_addr)
  → sin extern, sin colisiones de símbolos

Siguiente: git add + push para verificar que compila.
Luego Paso 6: UI tab Recovery.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""")
